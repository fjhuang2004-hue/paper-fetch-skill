...
mcp_tools = SimpleNamespace(
    ...
    batch_check_tool=lambda **kwargs: _call_with_namespace_deps(mcp_batch.batch_check_tool, kwargs),
    ...
    batch_resolve_tool=lambda **kwargs: _call_with_namespace_deps(mcp_batch.batch_resolve_tool, kwargs),
    ...
    fetch_paper_tool=lambda **kwargs: _call_with_namespace_deps(mcp_fetch_tool.fetch_paper_tool, kwargs),
