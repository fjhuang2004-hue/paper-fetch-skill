"""Elsevier REST API client — preserved for OA shortcut pathway (step ②)."""
...
register_provider_bundle(
    ProviderBundle(
        catalog=ProviderSpec(
            ...
            client_factory_path="paper_fetch.providers.elsevier_api:ElsevierApiClient",
            status_order=1,
...
class ElsevierApiClient(ProviderClient):
    name = "elsevier"
