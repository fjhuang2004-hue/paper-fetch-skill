...
_EXPORTS: dict[str, tuple[str, str]] = {
    ...
    "fetch_html_with_flaresolverr": ("paper_fetch.providers._flaresolverr", "fetch_html_with_flaresolverr"),
    ...
    "load_runtime_config": ("paper_fetch.providers._flaresolverr", "load_runtime_config"),
    ...
    "probe_runtime_status": ("paper_fetch.providers._flaresolverr", "probe_runtime_status"),
    "rewrite_inline_figure_links": (".html_extraction", "rewrite_inline_figure_links"),
    "warm_browser_context_with_flaresolverr": (
        "paper_fetch.providers._flaresolverr",
        "warm_browser_context_with_flaresolverr",
    ),
}
